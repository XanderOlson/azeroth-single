...
enum ServerConfigs
{
    ...
    CONFIG_PLAYER_SKILL_MAX_VALUE_OVERRIDE,
    ...
    CONFIG_SPELLMOD_DAMAGE_BONUS_PCT,
    CONFIG_ARMOR_DAMAGE_REDUCTION_CAP,
    CONFIG_ARMOR_DAMAGE_REDUCTION_MULTIPLIER,
    CONFIG_GLOBAL_COOLDOWN_MIN,
