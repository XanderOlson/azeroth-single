...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<float>(CONFIG_ARMOR_DAMAGE_REDUCTION_MULTIPLIER, "Armor.DamageReductionMultiplier", 1.0f, ConfigValueCache::Reloadable::Yes, [](float const& value) { return value >= 0.0f; }, ">= 0");
